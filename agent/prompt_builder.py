...
def build_skills_system_prompt(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "or troubleshoot Beam Agent itself — its CLI, config, models, providers, tools, "
            "skills, voice, gateway, plugins, or any feature — load the `beam-agent` skill "
            "first. It has the actual commands (e.g. `beam config set …`, `beam tools`, "
            "`beam setup`) so you don't have to guess or invent workarounds.\n"
