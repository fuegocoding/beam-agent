...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Beam Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ☄"              # Shown on exit
      response_label: " ☄ Beam "       # Response box header label
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Beam Agent"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Beam — gold and kawaii",
        "colors": {
        ...
        "branding": {
            ...
            "welcome": "Welcome to Beam Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ☄",
            "response_label": " ☄ Beam ",
            "prompt_symbol": "❯",
